...
const ExplorerLinks = () => {
  ...
  return (
    <div className="grid grid-flow-cols auto-cols-auto grid-cols-4 px-1 gap-2 lg:gap-6 text-4xl sm:text-6xl m-8 font-['Coolvetica'] font-extra-condensed font-bold uppercase">
      <Link
        className={`${
