        ...
        <div className="flex navbar-start w-full lg:w-1/2">
          <div className="lg:hidden dropdown" ref={burgerMenuRef}>
            ...
            {isDrawerOpen && (
              <ul
                tabIndex={0}
                className="menu menu-compact dropdown-content left-0 mt-0 mr-3 px-3.5 pb-2.5 shadow border-y-border bg-base-200 flex flex-col w-screen text-2xl gap-4 sm:gap-3"
                onClick={() => {
