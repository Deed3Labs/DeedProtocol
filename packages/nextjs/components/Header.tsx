        ...
        <div className="flex navbar-start w-full lg:w-1/2">
          <div className="lg:hidden dropdown border-0" ref={burgerMenuRef}>
            ...
            {isDrawerOpen && (
              <ul
                tabIndex={0}
                className="absolute left-0 menu menu-compact bg-[#0e0e0e] dropdown-content mt-2 px-3.5 pb-4.5 border-y border-white border-opacity-10 flex flex-col w-screen text-2xl gap-4 sm:gap-3"
                onClick={() => {
