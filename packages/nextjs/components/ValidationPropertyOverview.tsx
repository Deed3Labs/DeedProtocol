...
<<<<<<< HEAD
    <div className="flex flex-col gap-6 mt-4">
      <div className="flex flex-row border border-white border-opacity-10 p-6 gap-6 flex-wrap">
        <div className="w-80 h-80 bg-[#141414]">
          {/* Placeholder for the image or map */}
        </div>
        <div className="flex-grow">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col">
              <span className="text-[10px] font-normal text-zinc-400 uppercase tracking-widest">Owner</span>
              <Address address={deedData.owner} size="base" />
            </div>
            <div className="flex flex-col">
              <span className="text-[10px] font-normal text-zinc-400 uppercase tracking-widest">Validator</span>
...
>>>>>>> parent of 9c77f4d (Update ValidationPropertyOverview.tsx)
            </div>
            <button
              className="btn btn-outline w-12 p-3 rounded-md"
              onClick={handleChatClick}
          ...
          >
            <li>
              <Link href={`/registration/${deedData.id}`}>
                <a className="link-default">Edit</a>
              </Link>
            </li>
            {isValidator && (
              <li>
                <a onClick={handleMint} className="link-default">Mint</a>
              </li>
            )}
          </ul>
        </div>
