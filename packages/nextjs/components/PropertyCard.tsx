                ...
                <div class="self-stretch justify-between items-start gap-2.5 inline-flex">
                  <div class="flex-col justify-start items-start inline-flex">
                    <div class="self-stretch h-4 flex-col justify-start items-start flex">
                      <div class="text-white text-opacity-60 text-[1.8vw] sm:text-[0.68w] font-medium leading-none tracking-wider">PRICE</div>
                    </div>
                  ...
                  <div class="flex-col justify-start items-start inline-flex">
                    <div class="self-stretch h-4 flex-col justify-start items-start flex">
                      <div class="text-white text-opacity-60 text-[1.8vw] sm:text-[0.68vw] font-medium leading-none tracking-wider">TYPE</div>
                    </div>
                  ...
                  <div class="flex-col justify-start items-start inline-flex">
                    <div class="self-stretch h-4 flex-col justify-start items-start flex">
                      <div class="text-white text-opacity-60 text-[1.8vw] sm:text-[0.68vw] font-medium leading-none tracking-wider">ZONING</div>
                    </div>
