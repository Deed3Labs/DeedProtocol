      ...
      {!isLoading ? (
        errorCode && id ? (
          ...
          <div>
            ...
            {/* Map and Pictures */}
            <div className="flex flex-row w-full h-[364px] sm:h-[616px] gap-2 sm:gap-4">
              {/* Map */}
              <div className="w-[70%] sm:w-1/2 h-auto bg-[#141414] border border-white border-opacity-10">
              ...
              {/* Images */}
              <div className="w-[30%] sm:w-1/2 h-auto grid grid-rows-4 sm:grid-cols-2 gap-2 sm:gap-4">
