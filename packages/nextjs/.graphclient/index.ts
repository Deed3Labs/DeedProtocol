...
export type DeedEntityResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['DeedEntity'] = ResolversParentTypes['DeedEntity']> = ResolversObject<{
...
export type DeedMetadataResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['DeedMetadata'] = ResolversParentTypes['DeedMetadata']> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  ...
  ownerInformation_operatingAgreement?: Resolver<Maybe<ResolversTypes['FileInfo']>, ParentType, ContextType>;
  ownerInformation_articleIncorporation?: Resolver<ResolversTypes['FileInfo'], ParentType, ContextType>;
  ownerInformation_proofBill?: Resolver<Maybe<ResolversTypes['FileInfo']>, ParentType, ContextType>;
  ownerInformation_supportingDoc?: Resolver<Maybe<Array<ResolversTypes['FileInfo']>>, ParentType, ContextType, RequireFields<DeedMetadataownerInformation_supportingDocArgs, 'skip' | 'first'>>;
  ...
  propertyDetails_purchaseContract?: Resolver<Maybe<ResolversTypes['FileInfo']>, ParentType, ContextType>;
  propertyDetails_deedOrTitle?: Resolver<ResolversTypes['FileInfo'], ParentType, ContextType>;
  propertyDetails_images?: Resolver<Maybe<Array<ResolversTypes['FileInfo']>>, ParentType, ContextType, RequireFields<DeedMetadatapropertyDetails_imagesArgs, 'skip' | 'first'>>;
...
export type FileInfoResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['FileInfo'] = ResolversParentTypes['FileInfo']> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type QueryResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  deedEntity?: Resolver<Maybe<ResolversTypes['DeedEntity']>, ParentType, ContextType, RequireFields<QuerydeedEntityArgs, 'id' | 'subgraphError'>>;
  deedEntities?: Resolver<Array<ResolversTypes['DeedEntity']>, ParentType, ContextType, RequireFields<QuerydeedEntitiesArgs, 'skip' | 'first' | 'subgraphError'>>;
  deedMetadata?: Resolver<Maybe<ResolversTypes['DeedMetadata']>, ParentType, ContextType, RequireFields<QuerydeedMetadataArgs, 'id' | 'subgraphError'>>;
  deedMetadata_collection?: Resolver<Array<ResolversTypes['DeedMetadata']>, ParentType, ContextType, RequireFields<QuerydeedMetadata_collectionArgs, 'skip' | 'first' | 'subgraphError'>>;
  ...
  fileInfo?: Resolver<Maybe<ResolversTypes['FileInfo']>, ParentType, ContextType, RequireFields<QueryfileInfoArgs, 'id' | 'subgraphError'>>;
  fileInfos?: Resolver<Array<ResolversTypes['FileInfo']>, ParentType, ContextType, RequireFields<QueryfileInfosArgs, 'skip' | 'first' | 'subgraphError'>>;
  _meta?: Resolver<Maybe<ResolversTypes['_Meta_']>, ParentType, ContextType, Partial<Query_metaArgs>>;
}>;

export type SubscriptionResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Subscription'] = ResolversParentTypes['Subscription']> = ResolversObject<{
  deedEntity?: SubscriptionResolver<Maybe<ResolversTypes['DeedEntity']>, "deedEntity", ParentType, ContextType, RequireFields<SubscriptiondeedEntityArgs, 'id' | 'subgraphError'>>;
  deedEntities?: SubscriptionResolver<Array<ResolversTypes['DeedEntity']>, "deedEntities", ParentType, ContextType, RequireFields<SubscriptiondeedEntitiesArgs, 'skip' | 'first' | 'subgraphError'>>;
  deedMetadata?: SubscriptionResolver<Maybe<ResolversTypes['DeedMetadata']>, "deedMetadata", ParentType, ContextType, RequireFields<SubscriptiondeedMetadataArgs, 'id' | 'subgraphError'>>;
  deedMetadata_collection?: SubscriptionResolver<Array<ResolversTypes['DeedMetadata']>, "deedMetadata_collection", ParentType, ContextType, RequireFields<SubscriptiondeedMetadata_collectionArgs, 'skip' | 'first' | 'subgraphError'>>;
  ...
  fileInfo?: SubscriptionResolver<Maybe<ResolversTypes['FileInfo']>, "fileInfo", ParentType, ContextType, RequireFields<SubscriptionfileInfoArgs, 'id' | 'subgraphError'>>;
  fileInfos?: SubscriptionResolver<Array<ResolversTypes['FileInfo']>, "fileInfos", ParentType, ContextType, RequireFields<SubscriptionfileInfosArgs, 'skip' | 'first' | 'subgraphError'>>;
...
const deed3SepoliaHandler = new GraphqlHandler({
              name: "Deed3-Sepolia",
              config: {"endpoint":"https://api.studio.thegraph.com/query/56229/deed3-sepolia/version/latest"},
              baseDir,
              cache,
              pubsub,
