...
export const VehicleMakesAndModels = {
  ...
  Honda: ["Fit", "Civic", "Accord", "CR-V", "Pilot", "Odyssey", "Ridgeline", "HR-V", "Insight", "Passport"],
  Nissan: ["Micra", "Leaf", "Sentra", "Altima", "Maxima", "370Z", "GT-R", "Kicks", "Rogue", "Murano", "Pathfinder"],
  Hyundai: ["i10", "i20", "i30", "Elantra", "Sonata", "Tucson", "Santa Fe", "Kona", "Palisade", "Veloster"],
  Kia: ["Picanto", "Rio", "Soul", "Forte", "Optima", "Sorento", "Sportage", "Telluride", "Stinger", "Carnival"],
  Volkswagen: ["Polo", "Golf", "Passat", "Tiguan", "Arteon", "Touareg", "Atlas", "Jetta", "Beetle", "ID.4"],
  ...
  "Land Rover": ["Discovery", "Discovery Sport", "Range Rover Evoque", "Range Rover Velar", "Range Rover Sport", "Range Rover"],
